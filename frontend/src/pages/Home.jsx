...
const Home = () => {
  ...
  return (
    <section className="relative min-h-screen overflow-hidden px-4 py-20 md:px-8">
      ...
      <div className="relative mx-auto grid min-h-[82vh] max-w-7xl items-center gap-12 lg:grid-cols-[1.05fr_0.95fr]">
        <motion.div
        ...
        >
          ...
          <div className="glass-panel relative mx-auto max-w-md rounded-[2rem] p-5 shadow-cinemaGlow">
            <div className="relative h-[520px] overflow-hidden rounded-[1.5rem] bg-cinemaPanel">
